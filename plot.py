"""Create presentation and supporting figures for the ABM.

Inputs:
    A loaded Config, an output folder, simulation length, seed count, and sample
    interval.

Outputs:
    Presentation PNG figures, supporting PNG figures, and source CSV files for
    timing, strategy learning, congestion, scaling, food-spawn, and sector-score
    diagnostics.
"""
